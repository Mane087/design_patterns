namespace FactoryMethod {
  ...
  class MuebleFactory {
    static createMueble(tipo: keyof typeof TipoMueble): Mueble {
      return new TipoMueble[tipo]();
    }
  }

  const mublesFactory = MuebleFactory.createMueble("Silla");
  mublesFactory.create("Cuadrada", "Madera", 100);
